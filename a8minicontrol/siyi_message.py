"""
Python implementation of A8mini SDK by SIYI
"""
from os import stat
...
class SIYIMESSAGE:
    ...
    def gimbalRotateMsg(self, yaw_angle:int, pitch_angle:int):
        """
        Gimbal rotation Msg.
        Angle Control Range
        Yaw:
        A8 mini: -135.0 ~ 135.0 degree
        R10 / ZR30: Same with A8 mini
        ZT30: Limitless
        Pitch:
        A8 mini: -90.0 ~ 25.0 degree
        ZR10 / ZR30 / ZT30: Same with A8 mini
        ...
        # read mark
        yaw_angle_int = np.int16(yaw_angle*10)
        pitch_angle_int = np.int16(pitch_angle*10)
        

        data1=toHex(yaw_angle_int, 16)
        data2=toHex(pitch_angle_int, 16)
